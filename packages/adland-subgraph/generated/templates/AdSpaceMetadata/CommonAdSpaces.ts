...
export class AdGroupMetadataUpdated__Params {
  _event: AdGroupMetadataUpdated;

  constructor(event: AdGroupMetadataUpdated) {
    this._event = event;
  }
...
export class CommonAdSpaces__adGroupsResult {
  value0: Address;
  value1: string;
...
export class CommonAdSpaces__createAdGroupInputInitialAdSpaceConfigStruct extends ethereum.Tuple {
...
export class CommonAdSpaces extends ethereum.SmartContract {
  ...
  adGroups(param0: BigInt): CommonAdSpaces__adGroupsResult {
    let result = super.call("adGroups", "adGroups(uint256):(address,string)", [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);

    return new CommonAdSpaces__adGroupsResult(
      result[0].toAddress(),
      result[1].toString(),
    );
  }
  ...
  try_adGroups(
    param0: BigInt,
  ): ethereum.CallResult<CommonAdSpaces__adGroupsResult> {
    let result = super.tryCall(
      "adGroups",
      "adGroups(uint256):(address,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    return ethereum.CallResult.fromValue(
      new CommonAdSpaces__adGroupsResult(
        value[0].toAddress(),
        value[1].toString(),
      ),
    );
  ...
  createAdGroup(
    recipient: Address,
    initialAdSpaceConfig: CommonAdSpaces__createAdGroupInputInitialAdSpaceConfigStruct,
    size: BigInt,
    metadataURI: string,
  ): BigInt {
    let result = super.call(
      "createAdGroup",
      "createAdGroup(address,(address,uint256,uint256),uint256,string):(uint256)",
      [
  ...
  getGroup(adGroupId: BigInt): CommonAdSpaces__getGroupResultValue0Struct {
    let result = super.call(
      "getGroup",
      "getGroup(uint256):((address,string))",
...
export class CreateAdGroupCall__Inputs {
  ...
  get initialAdSpaceConfig(): CreateAdGroupCallInitialAdSpaceConfigStruct {
    return changetype<CreateAdGroupCallInitialAdSpaceConfigStruct>(
...
export class CreateAdGroupCallInitialAdSpaceConfigStruct extends ethereum.Tuple {
  get currency(): Address {
    return this[0].toAddress();
  }
...
export class UpdateAdGroupMetadataCall extends ethereum.Call {
  get inputs(): UpdateAdGroupMetadataCall__Inputs {
    return new UpdateAdGroupMetadataCall__Inputs(this);
  }

  get outputs(): UpdateAdGroupMetadataCall__Outputs {
    return new UpdateAdGroupMetadataCall__Outputs(this);
  }
}

export class UpdateAdGroupMetadataCall__Inputs {
  _call: UpdateAdGroupMetadataCall;

  constructor(call: UpdateAdGroupMetadataCall) {
    this._call = call;
  }
...
export class UpdateAdGroupMetadataCall__Outputs {
  _call: UpdateAdGroupMetadataCall;
