...
export function handleAdSpaceCreated(event: AdSpaceCreatedEvent): void {
  ...
  entity.adSpace_adGroupId = event.params.adSpace.adGroupId
  entity.adSpace_uri = event.params.adSpace.uri
  entity.adSpace_strategy = event.params.adSpace.strategy
